...
// Require the default configuration file
require_once (dirname(dirname(__FILE__)).'/config/config.php');

/* Please do not edit this lines, as the configuration is stored in 
 * ../config/config.php
 */
define('DATABASE_DRIVER', TRASHBOUNCER_DATABASE_driver);
define('DATABASE_HOST', TRASHBOUNCER_DATABASE_host);
define('DATABASE_PORT', TRASHBOUNCER_DATABASE_port);
define('DATABASE_USER', TRASHBOUNCER_DATABASE_user);
define('DATABASE_PASS', TRASHBOUNCER_DATABASE_pass);
define('DATABASE_DATABASE', TRASHBOUNCER_DATABASE_database);
define('DATABASE_PCONNECT', TRASHBOUNCER_DATABASE_pconnect);
define('DATABASE_CHARSET', TRASHBOUNCER_DATABASE_charset);
define('DATABASE_COLLATION', TRASHBOUNCER_DATABASE_collation);
